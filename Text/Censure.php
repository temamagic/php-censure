...
//                              ) \\1+
//                            /sxSX', '$1', $s);
		// Если делать так как выше то будет много ошибок на нормальные выражения, прим:
		// Ее бомбит, ее бензином, любое сочетание "ее б" без мата будет упрощено до "еб"
		$s = preg_replace('/(\w)\1{2,}/ui', '$1', $s); // Можно сделать так и удалять повторяющиеся более 2х подряд буквы. 
		// но слова типа хууй - не попадут в фильтр. А вот хуууй - уже пройдет  
